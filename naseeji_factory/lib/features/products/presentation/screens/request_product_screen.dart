...
import '../widgets/request_product_widgets.dart';

class RequestProductScreen extends ConsumerStatefulWidget {
  final String productId;

  const RequestProductScreen({super.key, required this.productId});

  @override
  ConsumerState<RequestProductScreen> createState() => _RequestProductScreenState();
}

class _RequestProductScreenState extends ConsumerState<RequestProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final estimatedCost = formState.calculateCost(product.price);
        ...
        child: formState.isLoading
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    SelectedProductWidget(product: product),
                    AppSpacing.hLG,
                    Text(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () async {
                              final success = await notifier.submitRequest(product.id);
