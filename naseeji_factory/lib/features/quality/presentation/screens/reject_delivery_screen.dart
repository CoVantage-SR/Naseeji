...
class RejectDeliveryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RejectDeliveryScreen> createState() => _RejectDeliveryScreenState();
}

class _RejectDeliveryScreenState extends ConsumerState<RejectDeliveryScreen> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              RejectHeaderWidget(order: order),
              AppSpacing.hMD,
