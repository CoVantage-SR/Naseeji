                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSummaryRow('السعر الأساسي', '${basePrice.toStringAsFixed(0)} ر.س'),
                      if (_discount > 0)
                        _buildSummaryRow('كود الخصم المطبق ($_appliedCoupon)', '-${_discount.toStringAsFixed(0)} ر.س'),
                      _buildSummaryRow('الضريبة المضافة (15% VAT)', '${vat.toStringAsFixed(2)} ر.س'),
                      const Divider(color: AppColors.outlineVariant),
                      _buildSummaryRow('المبلغ الإجمالي المستحق', '${grandTotal.toStringAsFixed(2)} ر.س', isBold: true),
                    ],
                  ),
                ),
                SizedBox(height: 16),
