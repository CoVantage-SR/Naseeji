                ...
                children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 2),
                                  Text('طريق الرياض - الدمام السريع • مركز المراقبة والوزن اللوجستي', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Theme.of(context).colorScheme.onSurface)),
                                ],
                              ),
                            ),
                          ],
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('تفاصيل التتبع والرحلة والعبور اللوجستي', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Theme.of(context).colorScheme.onSurface)),
                        SizedBox(height: 16),
