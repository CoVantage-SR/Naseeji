        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(carrier['icon'] as IconData, color: isSelected ? const Color(0xFF0040E0) : AppColors.outline, size: 22),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(carrier['name'] as String, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.onSurface)),
                        const SizedBox(height: 2),
                        Text(carrier['method'] as String, style: const TextStyle(fontSize: 10, color: AppColors.outline)),
                      ],
                    ),
                  ),
                  Radio<String>(
              ...
              Row(
                children: [
                  ...
                  Text(carrier['cost'] as String, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.green)),
                  const Spacer(),
                  const Text('مدة التوصيل: ', style: TextStyle(fontSize: 11, color: AppColors.outline)),
                  Text(carrier['time'] as String, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: AppColors.onSurface)),
                ],
              ),
