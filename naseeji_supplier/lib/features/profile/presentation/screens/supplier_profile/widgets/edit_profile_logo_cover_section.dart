  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('شعار وغلاف المنشأة', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
          ...
          Stack(
            children: [
              Container(
                ...
                child: currentCoverUrl.isEmpty ? const Center(child: Icon(Icons.image_outlined, size: 30, color: Colors.grey)) : null,
              ),
              if (isUploadingCover)
                Positioned.fill(
                  child: Container(
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  const Text('شعار الشركة الرسمي', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11)),
