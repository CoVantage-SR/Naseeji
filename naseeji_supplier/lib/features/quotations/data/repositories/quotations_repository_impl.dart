...
class QuotationsRepositoryImpl implements QuotationsRepository {
  final List<QuotationModel> _mockQuotations = [
    ...
    QuotationModel(
      ...
      revisions: [
        ...
        const QuotationRevisionModel(
          ...
          priceDifference: 5.0,
          reason: 'المورد قدم تنازلاً إضافياً بتخفيض السعر إلى ١٠٥ ر.س مع زيادة الخصم المباشر.',
          createdDate: '2026-07-05',
      ...
      timeline: [
        ...
        const QuotationTimelineStep(
          title: 'تقديم عرض سعر v1.0 بقيمة ١١٥ ر.س للوحدة',
          date: '2026-07-03',
          time: '01:00 م',
          responsibleUser: 'مورد نسيجي',
          status: 'مكتمل',
        ...
        const QuotationTimelineStep(
          title: 'استلام عرض مقابل (Counter Offer) من المصنع بقيمة ٩٠ ر.س',
          date: '2026-07-04',
          time: '10:30 ص',
        ...
        const QuotationTimelineStep(
          title: 'تقديم عرض محدث v2.0 بقيمة ١٠٥ ر.س للوحدة',
          date: '2026-07-05',
          time: '03:15 م',
          responsibleUser: 'مورد نسيجي',
          status: 'مكتمل',
    ...
    QuotationModel(
      ...
      revisions: [
        ...
        const QuotationRevisionModel(
          ...
          priceDifference: 0.0,
          reason: 'تم الاتفاق النهائي على ٧.٢ ر.س للبكرة بعد مراجعة تكاليف الإنتاج والخدمات اللوجستية.',
    ...
    QuotationModel(
      ...
      rejectionReason: 'السعر النهائي خارج الميزانية المقررة للمشروع (الميزانية القصوى للمصنع كانت ٤٠ ألف ر.س).',
      factoryInfo: const FactoryInfo(
        logoText: 'TC',
      ...
      timeline: [
        ...
        const QuotationTimelineStep(
          ...
          status: 'مرفوض',
          notes: 'نأسف لرفض العرض نظراً لأن التكلفة الكلية تتعدى الميزانية المحددة بمقدار ٢٠ ألف ر.س ولم ينجح خفض السعر الكافي.',
        ),
      ],
    ),
    QuotationModel(
