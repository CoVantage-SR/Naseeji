    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _buildTextField('سعر الوحدة (جنيه/م)', _unitPriceController)),
              SizedBox(width: 12),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryRow('سعر الوحدة', '${_unitPriceController.text} جنيه/متر'),
          _buildSummaryRow('المجموع الفرعي (Subtotal)', '${subtotal.toStringAsFixed(2)} جنيه'),
          _buildSummaryRow('الخصم المباشر المطبق', '- ${_discountController.text} جنيه'),
          _buildSummaryRow('ضريبة القيمة المضافة المعتمدة', '+ ${taxAmount.toStringAsFixed(2)} جنيه'),
          _buildSummaryRow('تكلفة النقل والشحن', '+ ${_shippingCostController.text} جنيه'),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSummaryRow('سعر الوحدة', '${_unitPriceController.text} جنيه'),
              _buildSummaryRow('السعر الإجمالي بعد الخصم والضريبة', '${grandTotal.toStringAsFixed(2)} جنيه'),
