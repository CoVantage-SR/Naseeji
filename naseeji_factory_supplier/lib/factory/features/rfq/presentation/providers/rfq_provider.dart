...
final List<RFQ> _mockRFQs = [
  const RFQ(
    ...
    offers: [
      RFQOffer(
        id: 'OFFER-101',
        supplierId: 'sup_1',
        supplierName: 'شركة مصر للغزل والنسيج',
      ...
      RFQOffer(
        ...
        supplierLogo: 'https://images.unsplash.com/photo-1572021335469-31706a17aaef?w=150',
        isVerified: true,
        isBestOffer: false,
        receivedDate: 'تم الاستلام في 12 مايو 2024 - 11:40 ص',
        totalPrice: 432500.0,
        deliveryDays: '10 أيام',
        paymentTerms: 'تحويل بنكي 50% مقدم',
      ),
      RFQOffer(
        id: 'OFFER-103',
        supplierId: 'sup_6',
        supplierName: 'شركة الإسكندرية للأقمشة والتصدير',
        supplierLogo: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=150',
        isVerified: true,
        isBestOffer: false,
  ...
  const RFQ(
    id: 'RFQ-2024-0046',
    rfqNumber: '#RFQ-2024-0046',
    title: 'طلب شراء خيوط بوليستر',
    productName: 'خيوط بوليستر عالية المتانة 150/48',
    productImage: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=500',
    category: 'خيوط',
    invitedSuppliersCount: 5,
    receivedQuotesCount: 2,
    negotiatingCount: 1,
    unrespondedCount: 2,
    createdDate: '15 مايو 2024 - 02:15 م',
    closingDate: '30 مايو 2024',
    remainingDays: '10 أيام متبقية',
    status: RFQStatus.waitingQuotations,
    currentStepIndex: 1,
    priority: 'medium',
    description: 'تأمين 5,000 كجم من خيوط البوليستر لإنتاج خط التريكو الرياضي.',
    material: 'بوليستر 100%',
    color: 'أبيض خام',
    size: '150/48 DTY',
    qualityLevel: 'درجة ممتازة AA',
    requestedQty: 5000,
    unit: 'كجم',
    attachments: ['مواصفات_الخيوط.pdf'],
    deliveryGovernorate: 'الجيزة',
    deliveryCity: '6 أكتوبر',
    deliveryAddress: 'المصنع الرئيسي - 6 أكتوبر',
    deliveryDate: '10 - 15 يونيو 2024',
    paymentTerms: 'تحويل بنكي 50% / 50%',
    currency: 'جنيه مصري (EGP)',
    offers: [
      RFQOffer(
        id: 'OFFER-201',
        ...
        isVerified: true,
        isBestOffer: true,
        receivedDate: 'تم الاستلام في 16 مايو 2024 - 10:00 ص',
        totalPrice: 275000.0,
        deliveryDays: '5 أيام',
        paymentTerms: 'تحويل بنكي 50% مقدم',
      ),
  ...
  const RFQ(
    id: 'RFQ-2024-0047',
    rfqNumber: '#RFQ-2024-0047',
    title: 'طلب صبغات نسيج تفاعلية',
    productName: 'صبغة نسيج تفاعلية (Reactive Blue)',
    productImage: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=500',
    category: 'أصباغ',
    invitedSuppliersCount: 4,
    receivedQuotesCount: 1,
    negotiatingCount: 0,
    unrespondedCount: 3,
    createdDate: '18 مايو 2024 - 09:00 ص',
    closingDate: '1 يونيو 2024',
    remainingDays: '12 يوم متبقي',
    status: RFQStatus.receivedQuotations,
    currentStepIndex: 1,
    priority: 'high',
    description: 'توريد صبغات تفاعلية زرقاء متوافقة مع معايير البيئة لخط الصباغة والطباعة.',
    material: 'صبغة كيميائية تفاعلية',
    color: 'أزرق نيفي (Navy Blue)',
    size: 'براميل 25 كجم',
    qualityLevel: 'معياري ISO 9001',
    requestedQty: 1200,
    unit: 'كجم',
    attachments: ['شهادة_السلامة_MSDS.pdf'],
    deliveryGovernorate: 'القاهرة',
    deliveryCity: 'شبين القناطر',
    deliveryAddress: 'مخزن الصباغة والكيماويات',
    deliveryDate: '1 - 5 يونيو 2024',
    ...
    offers: [
      RFQOffer(
        ...
        supplierLogo: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=150',
        isVerified: true,
        isBestOffer: true,
        receivedDate: 'تم الاستلام في 19 مايو 2024 - 11:30 ص',
        totalPrice: 168000.0,
        deliveryDays: '3 أيام',
        paymentTerms: 'دفع عند الاستلام',
      ),
