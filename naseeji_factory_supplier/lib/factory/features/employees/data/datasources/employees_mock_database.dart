...
class EmployeesMockDatabase {
  ...
  List<EmployeeEntity> _employees = [
    ...
    const EmployeeEntity(
      id: 'EMP001',
      name: 'مهندس / إبراهيم الششتاوي',
      jobTitle: 'مالك المصنع والرئيس التنفيذي',
      department: 'الإدارة العليا',
      role: 'owner',
      phone: '+20 10 0000 1111',
      email: 'ibrahim.sheshtawy@naseeji.com',
      photoUrl: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150',
      status: EmployeeStatus.active,
      joiningDate: '2020/01/01',
      employmentType: 'دوام كامل',
      lastLogin: 'منذ 5 دقائق',
      lastActivity: 'الموافقة على ميزانية شراء الخامات',
      permissionsCount: 13,
      permissions: _fullPermissions,
      managerName: 'مجلس الإدارة',
    ),
    // 2. EMP002 - مدير المشتريات
    const EmployeeEntity(
      id: 'EMP002',
      name: 'أحمد المحلاوي',
      jobTitle: 'مدير المشتريات والتوريدات',
      department: 'قسم المشتريات',
      role: 'purchasingManager',
      phone: '+20 10 1234 5678',
      email: 'ahmed.mahallawy@naseeji.com',
      photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
      status: EmployeeStatus.active,
      joiningDate: '2022/03/15',
      employmentType: 'دوام كامل',
      lastLogin: 'اليوم 08:45 ص',
      lastActivity: 'إرسال طلب عرض سعر #RFQ-2024-0045',
      permissionsCount: 6,
      permissions: _standardPermissions,
      managerName: 'إبراهيم الششتاوي',
    ),
    // 3. EMP003 - مديرة الجودة
    const EmployeeEntity(
      id: 'EMP003',
      name: 'مهندسة / سارة حسن',
      jobTitle: 'مديرة ضبط الجودة والمعامل',
      department: 'قسم الجودة',
      role: 'qualityInspector',
      phone: '+20 11 9876 5432',
      email: 'sara.hassan@naseeji.com',
      photoUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150',
      status: EmployeeStatus.active,
      joiningDate: '2022/08/10',
      employmentType: 'دوام كامل',
      lastLogin: 'اليوم 09:30 ص',
      lastActivity: 'اعتماد فحص جودة الشحنة #DEAL-8842',
      permissionsCount: 5,
      permissions: _standardPermissions,
      managerName: 'إبراهيم الششتاوي',
    ),
    // 4. EMP004 - مدير المستودع
    const EmployeeEntity(
      id: 'EMP004',
      name: 'عمر خالد الغندور',
      jobTitle: 'أمين المستودع والمخازن',
      department: 'قسم المخازن',
      role: 'warehouseManager',
      phone: '+20 10 9988 7766',
      email: 'omar.gandour@naseeji.com',
      photoUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150',
      status: EmployeeStatus.active,
      joiningDate: '2022/11/01',
      employmentType: 'دوام كامل',
      lastLogin: 'اليوم 10:15 ص',
      lastActivity: 'استلام شحنة قماش قطن من شركة مصر للغزل',
      permissionsCount: 5,
      permissions: _standardPermissions,
      managerName: 'أحمد المحلاوي',
    ),
    // 5. EMP005 - المدير المالي
    const EmployeeEntity(
      id: 'EMP005',
      name: 'نادية أحمد حسن',
      jobTitle: 'المديرة المالية والمحاسب الرئيسي',
      ...
      lastActivity: 'تسجيل دفعة اعتماد مستندي 426,000 ج.م',
      permissionsCount: 6,
      permissions: _standardPermissions,
      managerName: 'إبراهيم الششتاوي',
    ),
