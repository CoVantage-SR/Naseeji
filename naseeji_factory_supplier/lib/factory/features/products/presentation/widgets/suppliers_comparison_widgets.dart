...
/// 2. ChooseSupplierButtonWidget
class ChooseSupplierButtonWidget extends StatelessWidget {
  final VoidCallback onTap;

  const ChooseSupplierButtonWidget({super.key, required this.onTap});
...
class ComparisonRowWidget extends StatelessWidget {
  ...
  final List<bool>? highlightBest; // index indicators to color-highlight best choices
