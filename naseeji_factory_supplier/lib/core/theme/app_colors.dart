...
class AppColors {
  ...
  static const Color secondaryContainer = Color(0xFF72F8E4);
  ...
  static const Color surfaceVariant = Color(0xFFE2E1EF);
  ...
  static const Color surfaceContainerHigh = Color(0xFFE7E7F4);
  static const Color surfaceContainerHighest = Color(0xFFE2E1EF);
  static const Color tertiary = Color(0xFF993100);
